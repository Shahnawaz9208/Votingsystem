$(document).ready(function () {
    if($('.datatable-1').length>0){
        ...
        $('.dataTables_paginate > a:first-child').append('<i class="icon-chevron-left shaded" style="color:red;"></i>');
        $('.dataTables_paginate > a:last-child').append('<i class="icon-chevron-right shaded" style="color:red;"></i>');
...
// to show hide edit button function
    function editDiv() {	
        $('#show_after').show();
        $('#show_def').hide();
    }
